  ...
  return (
    <section id="experience" className="relative py-28 sm:py-36">
      ...
      <div className="absolute top-1/3 right-0 w-[500px] h-[500px] rounded-full opacity-10 pointer-events-none"
        style={{ background: 'radial-gradient(circle, rgba(232,96,76,0.3) 0%, transparent 70%)' }}
      />
          ...
          {experiences.map((exp) => (
            ...
            >
              ...
              <motion.div
                ...
                className="group relative rounded-2xl border border-base-600/40 hover:border-base-500/60 overflow-hidden transition-all duration-500 hover:shadow-2xl hover:shadow-amber-500/5"
              >
                {/* Card bg */}
                <div className="absolute inset-0 bg-base-850/90" />
                {/* Hover glow */}
                ...
                <div className="relative z-10 p-6 sm:p-8">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 sm:gap-4 mb-5">
                    <div>
                      ...
                      <p className="text-sm font-medium text-base-200 mt-1">{exp.role}</p>
                    </div>
                    <div className="flex flex-col sm:items-end gap-1 shrink-0">
                      ...
                      <span className="inline-flex items-center gap-2 text-xs font-medium text-base-300">
                  ...
                  {/* Gradient divider */}
                  <div className="h-px bg-gradient-to-r from-amber-500/30 via-base-600 to-transparent mb-5" />
                  ...
                  <ul className="space-y-3.5">
                    {exp.bullets.map((bullet, i) => (
                      <motion.li
                        ...
                        className="flex items-start gap-3 text-sm text-base-100 leading-relaxed"
                      >
