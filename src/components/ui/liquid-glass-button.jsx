...
function LiquidButton({
  ...
  return (
    ...
    >
      ...
      {/* Glass rim / border highlight */}
      <div 
        className="absolute inset-0 rounded-full"
        style={{
          border: '1px solid rgba(255,255,255,0.25)',
          boxShadow: 'inset 0 1px 1px rgba(255,255,255,0.3), inset 0 -1px 1px rgba(0,0,0,0.15), 0 0 20px rgba(255,255,255,0.08), 0 8px 32px rgba(0,0,0,0.12)',
        }}
      />

      {/* Top shine/reflection */}
      <div 
        className="absolute inset-x-0 top-0 h-1/2 rounded-t-full opacity-60 group-hover:opacity-80 transition-opacity duration-300"
        style={{
